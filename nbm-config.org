...
#+begin_src emacs-lisp :tangle yes
  ...
  (evil-define-key '(normal visual motion) 'global (kbd ",") 'nbm-key-tree-major-mode)
  (evil-define-key '(normal visual motion insert) 'global (kbd "M-RET") 'nbm-key-tree-major-mode)
  ...
  (evil-define-key 'emacs 'global (kbd "<f6>") 'nbm-key-tree-major-mode)
#+end_src
...
#+begin_src emacs-lisp :tangle yes
  ...
  (evil-define-key 'emacs dired-mode-map (kbd ",") 'nbm-key-tree-major-mode)
#+end_src
