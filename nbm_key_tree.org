...
**** key: d, function: org-table-delete-column
**** key: i, function: org-table-insert-column
**** key: l, function: org-table-move-column-left
**** key: r, function: org-table-move-column-right
** key: x, description: Text
