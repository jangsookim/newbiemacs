...
*** key: l, description: current bibitem to local, function: nbm-latex-copy-bib-item-to-local, level: 2
*** key: m, description: add from main to local, function: nbm-latex-insert-citation-and-copy-from-main-to-local, level: 2
