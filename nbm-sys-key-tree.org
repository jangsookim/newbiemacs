...
*** key: m, function: nbm-org-move-to-archived
** key: b, description: org-babel
*** key: t, function: org-babel-tangle
*** key: e, function: org-edit-special
*** key: s, function: nbm-org-sage-tangle
*** key: i, description: latex-in-line-math, function: nbm-org-latex-in-line-math
*** key: d, description: latex-display-math, function: nbm-org-latex-display-math
...
*** key: a, function: nbm-org-jump-to-archive
*** key: f, function: nbm-org-jump-to-file
*** key: h, function: nbm-org-jump-to-heading
*** key: u, function: nbm-org-jump-to-url
** key: h, description: HTML
*** key: e, function: nbm-org-html-export
*** key: t, function: nbm-org-html-theme
...
*** key: y, function: nbm-org-yank-code
