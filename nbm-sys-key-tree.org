...
*** key: e, description: find-by-extension, function: nbm-find-by-extension, level: 2
...
*** key: c, function: nbm-claude-open-vterm, level: 2
*** key: C, function: nbm-claude-open-terminal, level: 2
...
*** key: c, description: cite, function: nbm-latex-bibtex, level: 1
...
*** key: t, description: cite with theorem, function: nbm-latex-bibtex-theorem, level: 1
...
*** key: a, description: sage load all, function: nbm-org-sage-tangle, level: 3
*** key: s, description: sage load single, function: nbm-org-sage-single, level: 3
...
* description: vterm-mode, level: 3
** key: c, function: nbm-vterm-copy-mode-toggle, level: 3
** key: f, function: nbm-claude-insert-newest-file, level: 3
** key: m, function: nbm-claude-model, level: 3
** key: u, function: nbm-claude-usage, level: 3
** key: i, function: nbm-claude-insert-file-name, level: 3
** key: o, function: nbm-claude-find-org, level: 3
** key: r, description: recent file, function: nbm-claude-find-most-recent-file, level: 1
