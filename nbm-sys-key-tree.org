...
*** key: s, description: switch to same extension buffer, function: nbm-switch-to-buffer-with-same-extension, level: 1
...
*** key: m, description: MathSciNet, function: nbm-mathscinet-search, level: 1
*** key: x, description: ArXiv, function: nbm-arxiv-search, level: 1
...
*** key: e, description: change editing style, function: nbm-change-editing-style, level: 1
...
*** key: w, description: set default browser, function: nbm-set-default-browser, level: 1
...
** key: RET, description: paste prev math, function: nbm-latex-paste-previous-math, level: 1
** key: <backtab>, description: beginning of math mode, function: nbm-latex-exit-math-mode-front, level: 1
** key: TAB, description: end of math mode, function: nbm-latex-exit-math-mode, level: 1
** key: p, description: paste avy math, function: nbm-latex-paste-avy-math, level: 1
...
*** key: t, description: theorem, function: nbm-latex-insert-theorem, level: 1
*** key: l, description: lemma, function: nbm-latex-insert-lemma, level: 1
*** key: c, description: corollary, function: nbm-latex-insert-corollary, level: 1
*** key: p, description: proposition, function: nbm-latex-insert-proposition, level: 1
*** key: d, description: definition, function: nbm-latex-insert-definition, level: 1
...
*** key: e, description: new environment, function: LaTeX-environment, level: 1
...
*** key: B, description: create bib file, function: nbm-latex-extract-bib-file, level: 1
...
*** key: f, description: frac, function: nbm-latex-toggle-frac, level: 1
...
*** key: p, description: parenthesis, function: nbm-latex-toggle-parenthesis, level: 3
*** key: r, description: refcheck, function: nbm-latex-toggle-refcheck, level: 1
...
*** key: S, description: Solutions, function: nbm-latex-toggle-solutions, level: 1
*** key: $, description: dollar signs, function: nbm-latex-toggle-dollars, level: 1
