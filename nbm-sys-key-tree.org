...
** key: c, description: copy math, function: nbm-latex-copy-math, level: 1
** key: C, description: copy math with \( \), function: nbm-latex-copy-math-with-paren, level: 1
** key: d, description: delete math, function: nbm-latex-delete-math, level: 1
...
** key: D, description: delete math with \( \), function: nbm-latex-delete-math-with-paren, level: 1
