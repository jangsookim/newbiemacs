...
** key: c, description: codex, level: 1
*** key: c, function: nbm-ai-command, level: 1
*** key: x, function: nbm-codex-open-terminal, level: 1
*** key: l, function: nbm-claude-open-terminal, level: 1
