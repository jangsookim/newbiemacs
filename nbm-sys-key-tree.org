...
** key: RET, description: bookmark, function: helm-filtered-bookmarks, rank 1
** key: TAB, description: Last buffer, function: evil-switch-to-windows-last-buffer, rank 1
** key: ;, description: Toggle Korean/English, function: toggle-input-method, rank 1
** key: !, description: shell command, function: nbm-shell-commend, rank: 3
** key: ?, description: Help, function: nbm-cheat-sheet, rank 0
** key: 0, description: Developer only, rank 3
...
*** key: d, description: delete snippet, function: nbm-yasnippet-delete
...
*** key: r, description: reload all, function: yas-reload-all
...
*** key: l, description: label, function: nbm-reftex-goto-label
...
*** key: i, description: insert ref, function: nbm-reftex-insert-ref
...
** key: s, description: snippets
*** key: m, description: matrix, function: nbm-snippet-latex-matrix
*** key: y, description: Young tableau, function: nbm-snippet-latex-ytableau
** key: t, description: toggle/change
...
*** key: a, description: align, function: nbm-latex-toggle-align
*** key: l, description: label, function: reftex-change-label
*** key: m, description: multline, function: nbm-latex-toggle-multline
...
** key: j, description: Jump
*** key: a, description: archive, function: nbm-org-jump-to-archive
*** key: d, description: dir-link, function: nbm-org-jump-to-dir-at-point
*** key: f, description: file, function: nbm-org-jump-to-file
*** key: s, description: section/heading, function: nbm-org-jump-to-heading
*** key: t, description: tex, function: nbm-org-jump-to-tex
*** key: u, description: url, function: nbm-org-jump-to-url
