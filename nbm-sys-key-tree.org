...
*** key: s, function: save-buffer, level: 1
...
*** key: F, description: Finder (file manager), function: nbm-show-in-finder, level: 2
...
*** key: r, description: org-roam-node-find, function: org-roam-node-find, level: 1
...
*** key: m, function: delete-other-windows, level: 1
*** key: d, function: delete-window, level: 1
...
** key: Y, description: yasnippet, level: 1
...
*** key: i, description: insert-snippet, function: yas-insert-snippet, level: 1
...
*** key: t, description: table of snippets, function: yas-describe-tables, level: 1
...
** key: =, description: table of contents, function: reftex-toc, level: 2
...
** key: c, description: copy math, function: nbm-latex-copy-math, level: 2
** key: C, description: copy math with \( \), function: nbm-latex-copy-math-with-paren, level: 2
** key: d, description: delete math, function: nbm-latex-delete-math, level: 2
...
** key: D, description: delete math with \( \), function: nbm-latex-delete-math-with-paren, level: 2
...
*** key: l, description: label, function: nbm-latex-insert-label, level: 2
** key: j, description: jump, level: 2
...
*** key: m, description: macro, function: nbm-latex-new-macro, level: 2
...
*** key: r, description: reftex-reference, function: reftex-reference, level: 2
*** key: s, description: sec-ref, function: nbm-latex-sec-ref, level: 2
*** key: C, description: Cref, function: nbm-latex-Cref, level: 1
** key: s, description: snippets, level: 2
*** key: m, description: matrix, function: nbm-snippet-latex-matrix, level: 2
*** key: y, description: Young tableau, function: nbm-snippet-latex-ytableau, level: 2
** key: t, description: toggle/change, level: 1
*** key: b, description: bbl-file, function: nbm-latex-toggle-bbl-file, level: 2
*** key: e, description: equation, function: nbm-latex-toggle-equation, level: 2
...
*** key: v, description: change-variable, function: nbm-latex-change-variable, level: 1
...
** key: d, description: Dates, level: 2
*** key: c, description: consecutive dates, function: nbm-org-consecutive-dates, level: 2
*** key: d, description: deadline, function: org-deadline, level: 2
*** key: s, description: schedule, function: org-schedule, level: 2
*** key: t, description: time-stamp, function: org-time-stamp, level: 2
