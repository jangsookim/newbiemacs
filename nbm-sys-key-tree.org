...
*** key: b, description: bib item to local, function: nbm-latex-copy-bib-item-to-local, level: 2
...
*** key: K, description: toggle-dollar-korean, function: nbm-latex-toggle-dollar-korean, level: 3
