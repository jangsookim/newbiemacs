...
(defun tofus ()
  ...
  (mapc 'torus-local-set-key
	(list
	 (list [left] 'tofus-move-left)
	 (list [right] 'tofus-move-right)
	 (list [up] 'tofus-move-up)
	 (list [down] 'tofus-move-down)
	 (list (kbd "j") 'tofus-move-left)
	 (list (kbd "l") 'tofus-move-right)
	 (list (kbd "i") 'tofus-move-up)
	 (list (kbd "k") 'tofus-move-down)
	 (list (kbd "n") 'tofus-start-game)
	 (list (kbd "r") 'tofus-resume-game)
	 (list (kbd "q") 'tofus-end-game)
	 (list (kbd "c") 'tofus-change-theme)
	 (list (kbd "s") 'tofus-show-score-board)
	 (list (kbd "p") 'tofus-pause-game))))
