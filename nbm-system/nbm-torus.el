...
(defun torus-local-set-keybindings (theme)
  (cond ((equal theme 1) ;vi 
	 (mapc 'torus-local-set-key 
		...
		(list (kbd "h") 'torus-move-left)
		(list (kbd "l") 'torus-move-right)
		(list (kbd "k") 'torus-move-up)
		(list (kbd "j") 'torus-move-down)
	...
	((equal theme 2) ; emacs
	 (mapc 'torus-local-set-key 
		...
		(list [up] 'torus-move-up)
		(list [down] 'torus-move-down)
		(list (kbd "b") 'torus-move-left)
		(list (kbd "f") 'torus-move-right)
		(list (kbd "p") 'torus-move-up)
		(list (kbd "n") 'torus-move-down)
		(list (kbd "a") 'torus-start-game)
		(list (kbd "r") 'torus-resume-game)
		(list (kbd "q") 'torus-end-game)
		(list (kbd "c") 'torus-change-theme)
		(list (kbd "s") 'torus-show-score-board)
