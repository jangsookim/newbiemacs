...
(if (fboundp 'nbm-f)
    ...
    (defconst *torus-game-path* (concat (getenv "HOME") "/newbiemacs/nbm-user-settings/")))
...
(defun torus ()
  ...
  (if (fboundp 'evil-local-set-key)
    ...
    (progn
      (global-set-key [left] 'torus-move-left)
      (global-set-key [right] 'torus-move-right)
      (global-set-key [up] 'torus-move-up)
      (global-set-key [down] 'torus-move-down)
      (global-set-key (kbd "j") 'torus-move-left)
      (global-set-key (kbd "l") 'torus-move-right)
      (global-set-key (kbd "i") 'torus-move-up)
      (global-set-key (kbd "k") 'torus-move-down)
      (global-set-key (kbd "n") 'torus-start-game)
      (global-set-key (kbd "r") 'torus-resume-game)
      (global-set-key (kbd "q") 'torus-end-game)
      (global-set-key (kbd "c") 'torus-change-theme)
      (global-set-key (kbd "s") 'torus-show-score-board)
      (global-set-key (kbd "p") 'torus-pause-game))))
