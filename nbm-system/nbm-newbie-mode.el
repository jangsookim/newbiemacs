...
(defun newbie ()
  ...
  (evil-local-set-key 'normal (kbd "U") 'nbm-update-newbiemacs)
...
(defun newbie-print-version ()
  "Start newbie."
    (nbm-insert 1 (format "%83s" "Newbiemacs 0.98")))
...
(defun newbie-help ()
  (interactive)
  (browse-url "https://jangsookim.github.io/newbiemacs/newbiemacs-tutorial.html"))
