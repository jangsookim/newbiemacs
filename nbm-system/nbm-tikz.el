...
(defun nbm-tikz-lattice-path ()
  ...
  (let (code dimension X Y initial steps step)
    (setq dimension (read-string "Enter the size of a grid in the form \"X,Y\", where X is the max x-coordinate and Y is the max y-coordinate.\nIf you don't want a grid, just press the enter key.\n: "))
    (setq code "")
    (unless (equal dimension "")
    ...
    (setq initial (read-string "Enter the initial point in the form \"a,b\" (default: 0,0): " nil nil "0,0"))
